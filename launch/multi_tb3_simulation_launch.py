...
#     map_yaml_file = LaunchConfiguration('Testmap')
...
#         'robot1_params_file',
#         default_value=os.path.join(bringup_dir, 'config', 'nav2_multirobot_params_1.yaml'),
#         description='Full path to the ROS2 parameters file to use for robot1 launched nodes')

#     declare_robot2_params_file_cmd = DeclareLaunchArgument(
#         'robot2_params_file',
#         default_value=os.path.join(bringup_dir, 'config', 'nav2_multirobot_params_2.yaml'),
...
#             LogInfo(
#                 condition=IfCondition(log_settings),
#                 msg=[robot['name'], ' Testmap yaml: ', map_yaml_file]),
#             LogInfo(
#                 condition=IfCondition(log_settings),
